...
def merge_books_with_ratings():
    ...
    rating_data = pd.read_csv("../Data/Processed/isbn_ratings.csv", encoding="cp1252", on_bad_lines="skip")
...
def merge_books_and_ratings_with_details():
    ...
    details_data = pd.read_csv("../Data/Processed/book_details_save.csv", on_bad_lines="skip")
